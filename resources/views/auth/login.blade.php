...
{{--            <input type="email" name="email" id="login" class="fadeIn second {{ $errors->has('email') ? ' is-invalid' : '' }}" value="{{ old('email') }}" required autofocus>--}}
{{--            @if ($errors->has('email'))--}}
...
{{--             </span>--}}
{{--            @endif--}}
{{--            <input type="submit" class="fadeIn fourth " required value="Log In">--}}
